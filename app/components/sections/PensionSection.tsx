...
export default function PensionSection({ 
  ...
  return (
    <div className="space-y-6 pb-4 mb-4">
      ...
      <div>
        <h3 className="text-xs font-bold text-gray-900 mb-4 uppercase tracking-wider border-b pb-2">Bank Account Details</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="sm:col-span-2">
            ...
            />
            {errors.bankAccountName && <p className="text-red-600 text-xs mt-1">{errors.bankAccountName}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="011"
            />
            {errors.bankBranchCode && <p className="text-red-600 text-xs mt-1">{errors.bankBranchCode}</p>}
          </div>
          ...
          <div className="sm:col-span-2">
            ...
            />
            {errors.bankBranchName && <p className="text-red-600 text-xs mt-1">{errors.bankBranchName}</p>}
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            ...
            {errors.contributionRate && <p className="text-red-600 text-xs mt-1">{errors.contributionRate}</p>}
          </div>
